...
export const getSearchingMovie = async (find) => await axios.get(`https://api.themoviedb.org/3/search/movie?query=${find}&include_adult=true&language=en-US&page=32`, options)
    .catch(function (error) { Notiflix.Notify.failure(`${error.message}`) });
